...
const getOneProduct = async (req, res) => {
    try {
        ...
        console.log("getOneProduct verisi çekilemedi!", err)
    }
}
...
const createProduct = async (req, res) => {
    try {
        ...
        console.log("Ürün oluştururken hata!", err)
    }
}
...
const updateProduct = async (req, res) => {
    ...
    updateProduct = awaitProduct.findByIdAndUpdate(req.params.id, req.body, { new: true, runValidators: true });
